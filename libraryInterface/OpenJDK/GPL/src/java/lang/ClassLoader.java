...
public abstract class ClassLoader {
    ...
    private final HashMap<String, Package> definedPackages = new HashMap<String, Package>();
    ...
    private static BootstrapClassLoader systemClassLoader;
        ...
        if (c == null) {
            try {
                if (parent != null) {
                    ...
                    c = BootstrapClassLoader.getBootstrapClassLoader().loadClass(name, false);
                }
    ...
    */
    ...
    private boolean checkName(String name) {
        if ((name == null) || (name.length() == 0))
            return true;
        if ((name.indexOf('/') != -1)
            || (!sun.misc.VM.allowArraySyntax() && (name.charAt(0) == '[')))
            return false;
        return true;
    }
    ...
    public static ClassLoader getSystemClassLoader() {
        ...
        if (sc != null) {
            ...
            if (callerLoader != null && callerLoader != systemClassLoader) {
                sc.checkPermission(SecurityConstants.GET_CLASSLOADER_PERMISSION);
            }
        }
    ...
    static ClassLoader getCallerClassLoader() {
        return RVMClass.getClassLoaderFromStackFrame(1); 
    }
