...
@Uninterruptible public class VM_Thread implements ArchitectureSpecific.VM_StackframeLayoutConstants {
  ...
  /**
   * Get the current java.lang.Thread.  Prints out a warning if
   * someone asks for a thread too soon.  The warning is for code that
   * does not expect to be called early in the boot process.  Use
   * peekJavaLangThread if you expect you might get null.
   */
  @Interruptible
  ...
  /**
   * Peek at the current java.lang.Thread.  Do not print out any
   * warnings. This is used by code that expects it might be called
   * early in the boot process.  Use getJavaLangThread if your caller
   * is not necessarily prepared to get null.
   */
  @Interruptible
  ...
  */
  ...
  /** @return Is this the boot thread? */
