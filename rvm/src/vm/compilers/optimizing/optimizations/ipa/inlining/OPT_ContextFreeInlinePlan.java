    ...
    for (String s = in.readLine(); s!= null; s = in.readLine()) {
      ...
      if (!nextToken1.equals("null")) {
        ...
        if (nextToken1.equals("BootstrapCL")) {
          tref = VM_TypeReference.findOrCreate(VM_BootstrapClassLoader.getVMClassLoader(), callerClass);
      ...
      if (!nextToken1.equals("null")) {
        ...
        VM_TypeReference tref;
        if (nextToken1.equals("BootstrapCL")) {
          tref = VM_TypeReference.findOrCreate(VM_BootstrapClassLoader.getVMClassLoader(), calleeClass);
        } else if (nextToken1.equals("SystemAppCL")) {
