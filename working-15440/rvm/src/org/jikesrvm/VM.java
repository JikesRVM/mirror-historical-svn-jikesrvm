...
public class VM extends Properties implements Constants, ExitStatus {
  ...
  @NoInline
  public static void sysWriteln(String s1, Address a,String s2, Offset o) {
    swLock();
    write(s1);
    write(a);
    write(s2);
  ...
  @NoInline
  public static void sysWriteln(String s1, int i1, String s2, boolean b1) {
    swLock();
    write(s1);
    write(i1);
    write(s2);
  ...
  @NoInline
  public static void sysWriteln(String s1, int i1, String s2, int i2, String s3, double d1, String s4) {
    swLock();
    write(s1);
    write(i1);
    write(s2);
  ...
  @NoInline
  public static void tsysWriteln(String s1, Address a1, String s2, Offset o1) {
    swLock();
    showThread();
    write(s1);
    write(a1);
  ...
  public static void sysExit(int value) {
    ...
    if (VM.reportRuntimeProfile) {
      RVMThread.reportRuntimeProfile();
    }
