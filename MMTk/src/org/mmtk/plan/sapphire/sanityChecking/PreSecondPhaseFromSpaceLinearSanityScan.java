 ...
 */
@Uninterruptible
public class PreSecondPhaseFromSpaceLinearSanityScan extends LinearScan {
  /**
   * Scan an object.
   * 
   * @param object
    ...
    if (VM.VERIFY_ASSERTIONS) {
      if (!object.isNull()) {
        ...
        if (VM.scanning.pointsTo(object, Sapphire.toSpace().getDescriptor())) {
          Log.write("PreSecondPhaseFromSpaceLinearSanityScan: Object ");
          Log.write(object);
        ...
        // Log.writeln("PreSecondPhaseFromSpaceLinearSanityScan found interesting reference details are:");
