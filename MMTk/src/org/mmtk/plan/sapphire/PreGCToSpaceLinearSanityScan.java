...
public class PreGCToSpaceLinearSanityScan extends LinearScan {
  ...
  public void scan(ObjectReference object) {
    if (VM.VERIFY_ASSERTIONS) {
      if (!object.isNull()) {
        // Log.write("PreGC ToSpaceScanning... "); Log.writeln(object);
